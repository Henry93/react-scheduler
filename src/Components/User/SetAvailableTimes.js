...
import './css/SetAvailableTimes.css';

class SetAvailableTimes extends Component {
    ...
    return (
      <div className="Time-Table">
        <Container>
          <Row>
            <Col>
              <h4>Please select available times and click Save</h4><br /><br />
            </Col>
          </Row>
          <Row>
            <Col>
      ...
      <hr /><br />
          ...
          <Row>
            <Col>
              <h5 className="selectTime">Select Times</h5><br />
            </Col>
          </Row>
          <Row>
            <Col>
      ...
      <br /><div className="line"><span>Noon</span></div><br />
        ...
        <Row>
          <Col>
            <br /><br /><Button className="backbtn" onClick={() => window.location.href='/calendar'} color="primary">Back</Button>
            <Button className="savebtn" onClick={() => window.location.href=`/saveconf?time=${this.state.cSelected}`} color="primary">Save</Button>
          </Col>
        </Row>
        </Container>
      </div>
